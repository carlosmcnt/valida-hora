export const getAluno = async (id) => {
    try {
      ...
      console.log("Usuário logado:", aluno);
    } catch (error) {
      alert(error.message || "Erro buscar aluno");
    }
  };

export const cursos = {
  1: { nome: 'Ciência da Computação' },
  2: { nome: 'Sistema de informações' },
  3: { nome: 'Licenciatura em Computação' }
}
